...
const RightSidebar = ({ selectedUser }) => {
    return selectedUser && (
        <div className={`bg-[#141221]/60 backdrop-blur-md text-white w-full h-full flex flex-col justify-between border-l border-gray-800/40 ${selectedUser ? "max-md:hidden" : ""}`}>
            ...
            <div className='overflow-y-auto flex-1 p-6 space-y-6 custom-scrollbar min-h-0'>
                ...
                <div className='flex flex-col items-center text-center pt-6'>
                    <div className="relative group mb-4">
                        ...
                        />
                        <span className='absolute bottom-1 right-1 w-4 h-4 rounded-full bg-green-500 ring-4 ring-[#141221] animate-pulse'></span>
                    </div>

                    <h1 className='text-lg font-semibold tracking-wide flex items-center justify-center gap-2 w-full px-4'>
                        <span className="truncate max-w-50">{selectedUser.fullName}</span>
                    </h1>
                ...
                <div className='space-y-3'>
                    <div className="flex items-center justify-between px-1">
                        ...
                        <span className="text-[10px] bg-purple-500/10 text-purple-400 px-2 py-0.5 rounded-full font-mono">{imagesDummyData.length} files</span>
                    </div>
